    ...
    return (
        <div className='flex min-h-screen mt-7'>
            <div className="w-full max-w-3xl mx-auto flex flex-col lg:flex-row ">
                <div>
                    <div className="mb-8 lg:mb-12 cursor-pointer p-3" onClick={() => router.push('/')}>
                    ...
                    <div>
                        ...
                        <p className='text-base sm:text-lg lg:text-xl text-gray-400 mb-6 sm:mb-8'>
                            {isSignUp ? 'Join SnuggleCart today and discover a sense of curated, perhaps artisan or unique, modern goods.' : 'Welcome Back to SnuggleCart! Log in to continue your shopping journey!'}
                        </p>
                    </div>
